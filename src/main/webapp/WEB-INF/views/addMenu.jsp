        ...
        <script>
              ...
              m.controller("userInfo",function($scope , $http){
            	  ...
            	  $scope.submit = function()
            		{
            		data = {id:$scope.id,name:$scope.name , url:$scope.url};
...
<div class="sidebar">
 ...
 <br><br>
		...
		<h1>ADD MENU</h1>
					...
					<form>
					<br><br>
					<b class="size">MENU Id</b><br>
					<input type="text" placeholder="Enter MenuId" class="input" ng-model="id"/><br><br>
					<br><br>
					<b class="size">MENU NAME</b><br>
					<input type="text" placeholder="Enter MenuName" class="input" ng-model="name"/><br><br>
					<br><br>
					<b class="size">URL</b><br>
					<input type="text" placeholder="Enterurl" class="input" ng-model="url"/>
					<br><br><br><br>
                    </form> 
