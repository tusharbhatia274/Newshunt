...
<meta charset="utf-8">
        ...
        <script>
              ...
              m.controller("channelInfo",function($scope,$http){
            	...
            	{
            		$http.post("channel").then(function(resp){
...
<br> <br>
		...
		<div class="card">	
			...
			<div class="container"><br>
				<h2>
					<b>{{x.title}}</b><br><br>
					<img src="{{x.image}}" align="left" height="40" width="40"></image>
					
				</h2><br><br>
				<input type="checkbox" ng-model="x.selected"><strong>Subscribe</strong> <br>
			</div>
		</div>
		<br> <br>
	</div>
	...
	<div class="wrapper">
		<button class="button" ng-click="subscribe()">Subscribe</button>
	</div>
	</div>
</center>
</body>
